export const posts = [
    ...
    },
    {
        ...
        category: 'Homens',
        readTime: '5 min',
        title: 'O Ressurgimento da Masculinidade Clássica',
        excerpt: 'Em tempos de papéis fluidos, revisitar os fundamentos da proteção, provisão e propósito se torna um ato revolucionário.',
        content: [
            "Masculinidade não é sobre dominação, mas sobre competência. Ser capaz de proteger os seus e prover não apenas recursos, mas segurança emocional e direção.",
            "A sociedade moderna tenta vilanizar a assertividade, confundindo-a com agressividade. O homem estoico sabe a diferença. A agressividade é descontrole; a assertividade é poder sob controle.",
            "Cultivar a força física e mental não é vaidade, é dever. Um homem fraco não pode ser virtuoso, pois a virtude exige a capacidade de, podendo fazer o mal, escolher o bem."
        ]
    },
    {
        id: 4,
        ...
        category: 'Tutoriais',
        readTime: '7 min',
        title: 'Implementando um Segundo Cérebro (Zettelkasten) no Obsidian',
        excerpt: 'Um guia prático para transformar notas dispersas em um sistema de conhecimento interconectado.',
        content: [
            "A mente humana serve para ter ideias, não para armazená-las. Tentar lembrar de tudo é a receita para a ansiedade e esquecimento.",
            "O método Zettelkasten propõe a criação de notas atômicas — uma ideia por nota — conectadas entre si. Imagine sua base de conhecimento não como um armário de arquivos (pastas), mas como uma rede neural (links).",
            "Passo 1: Crie uma pasta 'Inbox'. Passo 2: Capture tudo sem julgar. Passo 3: Uma vez por dia, processe a Inbox, transformando rascunhos em Notas Permanentes e conectando-as a conceitos existentes."
        ]
    }
];

export const categories = ['Todos', 'Filosofia', 'Disciplina', 'Homens', 'Tutoriais', 'Dicas', 'Documentação'];
